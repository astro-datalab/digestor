...
-------------------------------------------------------------------------------
    ...
    bal_flag_vi        int NOT NULL, --/D BAL flag from visual inspection
    ...
    var_matched        int NOT NULL, --/D Variability information flag
    ...
    xmm_lum_flag       real NOT NULL, --/D Flag for upper limit for hard X-ray flux --/F LUMX2_12_UPPER
    sdss2xmm_sep       real NOT NULL, --/U arcsec --/D SDSS-XMM-Newton separation
    galex_matched      int NOT NULL, --/D GALEX match flag
