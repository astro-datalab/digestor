CREATE TABLE spiders_quasar (
  ...
  RA					real NOT NULL,				--/D Right ascension of the X-ray detection (J2000).
  DEC					real NOT NULL,				--/D Declination of the X-ray detection (J2000).
  ...
  fiberID  				bigint NOT NULL,			--/D SDSS fibre identification.
  DR14_RUN2D   			varchar(32) NOT NULL,		--/D Spectroscopic reprocessing number.
  DR14_PLUG_RA          real NOT NULL,				--/D Right ascension of the drilled fibre position.
  DR14_PLUG_DEC   		real NOT NULL,				--/D Declination of the drilled fibre position.
