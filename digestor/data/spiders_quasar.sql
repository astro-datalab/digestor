CREATE TABLE spiders_quasar (
    ...
    --
    --/T  This table contains data for the SPIDERS
    --/T (SPectroscopic IDentification of ERosita Sources) quasar
    --/T spectroscopic followup Value Added Catalog (VAC) based on SDSS DR14.
    -------------------------------------------------------------------------------
  ...
  name 					varchar(32) NOT NULL,       --/D Name of the X-ray detection.
  RA					float NOT NULL,				--/U deg --/D Right ascension of the X-ray detection (J2000).
  DEC					float NOT NULL,				--/U deg --/D Declination of the X-ray detection (J2000).
  ExpTime				real NOT NULL,				--/U s --/D Exposure time of the X-ray detection.
  ...
  f_2RXS              	real NOT NULL,				--/U erg/cm2/s --/D Flux in the 0.1-2.4 keV range (2RXS).
  errf_2RXS           	real NOT NULL,				--/U erg/cm2/s --/D Uncertainty in the flux in the 0.1-2.4 keV range (2RXS).
  fden_2RXS           	real NOT NULL,				--/U erg/cm2/s/Hz --/D Flux density at 2 keV (2RXS).
  errfden_2RXS        	real NOT NULL,				--/U erg/cm2/s/Hz --/D Uncertainty in the flux density at 2 keV (2RXS).
  f_XMMSL				real NOT NULL,				--/U erg/cm2/s --/D Flux in the 0.2-12 keV range (XMMSL).
  errf_XMMSL			real NOT NULL,				--/U erg/cm2/s --/D Uncertainty in the flux in the 0.2-12 keV range (XMMSL).
  ...
  DR14_ZWARNING   		tinyint NOT NULL,			--/D Warning flag for SDSS spectra.
  ...
  norm_pl1       		real NOT NULL,				--/U erg/cm2/s/A --/D Normalisation of the power law fit to the MgII continuum region.
  errnorm_pl1   		real NOT NULL,				--/U erg/cm2/s/A --/D Uncertainty in the normalisation of the power law fit to the MgII continuum region.
  ...
  norm_pl2        		real NOT NULL,				--/U erg/cm2/s/A --/D Normalisation of the power law fit to the H beta continuum region.
  errnorm_pl2     		real NOT NULL,				--/U erg/cm2/s/A --/D Uncertainty in the normalisation of the power law fit to the H beta continuum region.
  ...
  norm_gal1      		real NOT NULL,				--/U erg/cm2/s/A --/D Normalisation of the galaxy model used to fit the MgII continuum region.
  errnorm_gal1   		real NOT NULL,				--/U erg/cm2/s/A --/D Uncertainty in the normalisation of the galaxy model used to fit the MgII continuum region.
  norm_gal2       		real NOT NULL,				--/U erg/cm2/s/A --/D Normalisation of the galaxy model used to fit the H beta continuum region.
  errnorm_gal2   		real NOT NULL,				--/U erg/cm2/s/A --/D Uncertainty in the normalisation of the galaxy model used to fit the H beta continuum region.
  norm_feII1    		real NOT NULL,				--/U erg/cm2/s/A --/D Normalisation of the iron template model used to fit the MgII continuum region.
  errnorm_feII1   		real NOT NULL,				--/U erg/cm2/s/A --/D Uncertainty in the normalisation of the iron template model used to fit the MgII continuum region.
  norm_feII2     		real NOT NULL,				--/U erg/cm2/s/A --/D Normalisation of the iron template model used to fit the H beta continuum region.
  errnorm_feII2   		real NOT NULL,				--/U erg/cm2/s/A --/D Uncertainty in the normalisation of the iron template model used to fit the H beta continuum region.
  width_feII1   		real NOT NULL,				--/U km/s --/D FWHM of the Gaussian kernel convolved with the iron template used to fit the MgII continuum region.
  errwidth_feII1   		real NOT NULL,				--/U km/s --/D Uncertainty in the FWHM of the Gaussian kernel convolved with the iron template used to fit the MgII continuum region.
  width_feII2   		real NOT NULL,				--/U km/s --/D FWHM of the Gaussian kernel convolved with the iron template used to fit the H beta continuum region.
  errwidth_feII2   		real NOT NULL,				--/U km/s --/D Uncertainty in the FWHM of the Gaussian kernel convolved with the iron template used to fit the H beta continuum region.
  ...
  l_2500          		real NOT NULL,				--/U erg/s/A --/D Monochromatic luminosity at 2500 Ang.
  errl_2500      		real NOT NULL,				--/U erg/s/A --/D Uncertainty in the monochromatic luminosity at 2500 Ang.
  l_3000         		real NOT NULL,				--/U erg/s/A --/D Monochromatic luminosity at 3000 Ang.
  errl_3000      		real NOT NULL,				--/U erg/s/A --/D Uncertainty in the monochromatic luminosity at 3000 Ang.
  l_5100          		real NOT NULL,				--/U erg/s/A --/D Monochromatic luminosity at 5100 Ang.
  errl_5100      		real NOT NULL,				--/U erg/s/A --/D Uncertainty in the monochromatic luminosity at 5100 Ang.
  l_bol1         		real NOT NULL,				--/U erg/s --/D Bolometric luminosity derived from the monochromatic luminosity at 3000 Ang.
  errl_bol1      		real NOT NULL,				--/U erg/s --/D Uncertainty in the bolometric luminosity derived from the monochromatic luminosity at 3000 Ang.
  l_bol2         		real NOT NULL,				--/U erg/s --/D Bolometric luminosity derived from the monochromatic luminosity at 5100 Ang.
  errl_bol2     		real NOT NULL,				--/U erg/s --/D Uncertainty in the bolometric luminosity derived from the monochromatic luminosity at 5100 Ang.
  ...
  logBHMMD_hb   		real NOT NULL,				--/U log(M_solar) --/D Black hole mass derived from the H beta line using the McLure & Dunlop (2004) calibration.
  errlogBHMMD_hb   		real NOT NULL,				--/U log(M_solar) --/D Uncertainty in the black hole mass derived from the H beta line using the McLure & Dunlop (2004) calibration.
  ...
  l_edd1         		real NOT NULL,				--/U erg/s --/D Eddington luminosity based on the black hole mass estimate derived using the Shen & Liu (2012) calibration.
  l_edd2         		real NOT NULL,				--/U erg/s --/D Eddington luminosity based on the black hole mass estimate derived using the Assef et al. (2011) calibration.
